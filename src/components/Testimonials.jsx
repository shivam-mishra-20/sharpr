...
const Testimonials = () => {
  ...
  const startProgressInterval = () => {
    ...
    }, 30); // 30ms * 200 steps = ~6 seconds total
  };
                    ...
                    >
                      <motion.div
                        ...
                        style={{
                          ...
                          boxShadow: `0 0 0 2px ${colors.card}, 0 8px 20px rgba(0,0,0,0.1)`,
                        }}
                      >
                        <img
                          ...
                          onError={(e) => {
                            ...
                            e.target.src = `https://ui-avatars.com/api/?name=${testimonials[index].name}&background=random`;
                          }}
                        />
                      </motion.div>
                  ...
                  >
                    ...
                    <p
                      style={{
                        ...
                        fontStyle: "italic",
                        position: "relative",
                        textAlign: "left", // Left align the quote text
                      }}
                    >
                      "{testimonials[index].quote}"
                    </p>
